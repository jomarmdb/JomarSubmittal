...
/* --- Info boxes ("No items selected yet.") --- */
div[data-testid="stAlert"] {
    background-color: #fff7f7 !important; /* subtle red-tint background */
...
div[data-testid="sortable-item"]:hover {
    background-color: #BC141B20 !important; /* semi-transparent Jomar red */
